...
dl_stats_perip_perday AS (
  ...
  GROUP BY test_date, continent_code, country_code, country_name, ISO3166_2region1, city, ip
),
...
dl_stats_per_day AS (
  ...
  GROUP BY test_date, continent_code, country_code, country_name, ISO3166_2region1, city
),
...
JOIN ul_histogram USING (test_date, continent_code, country_code, country_name, ISO3166_2region1, city, bucket_min, bucket_max)
JOIN dl_stats_per_day USING (test_date, continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN dl_total_samples_per_geo USING (test_date, continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN ul_stats_per_day USING (test_date, continent_code, country_code, country_name, ISO3166_2region1, city)
JOIN ul_total_samples_per_geo USING (test_date, continent_code, country_code, country_name, ISO3166_2region1, city)
ORDER BY test_date, continent_code, country_code, country_name, ISO3166_2region1, city, bucket_min, bucket_max
