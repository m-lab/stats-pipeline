...
dl_stats_per_day AS (
  SELECT
    date, continent_code, country_code, asn,
...
results AS (
  ...
  dl_histogram
  JOIN ul_histogram USING (date, continent_code, country_code, asn, bucket_min,
  bucket_max)
...
ORDER BY date, continent_code, country_code, asn, bucket_min
